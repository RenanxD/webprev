    ...
    <div class="container">
        ...
        <div class="row">
                    ...
                    <div class="card-body">
                        ...
                        @if ($cobrancaAtual && $cobrancaAtual->cobranca_ativa)
                            <p class="card-text"><strong
                                    style="font-size: 14px;">Descrição:</strong><br>{{ $cobrancaAtual->descricao }}</p>
                            <div class="row">
                                <div class="col-md-2">
                        ...
                        @elseif (isset($ultimaCobrancaAtiva))
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    <p class="card-text"><strong style="font-size: 14px;">Permanência
                                            Mínima:</strong><br>{{ $ultimaCobrancaAtiva->cobranca_perm_minima }}</p>
                                </div>
                                <div class="col-md-2">
                                    <p class="card-text"><strong style="font-size: 14px;">Valor Diário
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Todas as cobranças Cadastradas</h5>
                                ...
                                @foreach($cobrancas as $cobranca)
                                    <tr>
                                        ...
                                        <td class="d-flex justify-content-between align-items-center">
                                            ...
                                            <form action="{{ route('cobrancas.destroy', $cobranca->id_cobranca) }}" method="POST"
                                                  class="d-inline">
                                                @csrf
                                                @method('DELETE')
